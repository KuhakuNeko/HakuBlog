#! /bin/sh
# BashBlog Haku Version
# ReEdited By KuhakuNeko
...
global_variables() {
    ...
    # Blog title
    global_title="Kuhaku Blog"
    # The typical subtitle for each blog
    global_description="Music🎶, Games🎮, Arts🎨, Technology💻, Cars🚗 & Whatever comes to my mind... 💭"
    # The public base URL for this blog
    global_url="https://kuhakuneko.github.io/HakuBlog/"

    # Your name
    global_author="KuhakuNeko"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="https://kuhakuneko.github.io/online-cv/" 
    # Your email
    global_email="p19kost2@gmail.com"
    ...
    # "View all posts" (used on bottom of index page as link to archive)
    template_archive="View all posts"
...
create_css() {
    ...
    if [[ -f ../style.css ]] && [[ ! -f main.css ]]; then
        ...
        echo 'body{font-family:"Open Sans";margin:0;padding:0;background-color:#10192d;}
        #divbodyholder{padding:5px;background-color:#ff5370;width:70%;max-width:1920px;margin:24px auto;}
        #divbody{border:solid 1px #ff5370;background-color:#fff;padding:0px 48px 24px 48px;top:0;}
        .headerholder{background-color:#ececec;border-top:solid 1px #ccc;border-left:solid 1px #ccc;border-right:solid 1px #ccc;}
        ...
        .clear{clear:both;}
        #footer{padding-top:10px;border-top:solid 1px rgb(255, 245, 108);color:#c00040;text-align:center;font-size:small;font-family:"Roboto", monospace;}
        a{text-decoration:none;color:#0080ff !important;}
        a:visited{text-decoration:none;color:#174e86 !important;}
